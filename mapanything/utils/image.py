...
ASPECT_RATIO_KEYS = {
    ...
    476: sorted(RESOLUTION_MAPPINGS[476].keys()),
    1036: sorted(RESOLUTION_MAPPINGS[1036].keys()),
}
...
def load_images(
    ...
    Args:
        ...
        crop_bottom_percent (float, optional): Percentage of the bottom of the image to crop (e.g., 0.1 for 10%). Defaults to 0.0.
